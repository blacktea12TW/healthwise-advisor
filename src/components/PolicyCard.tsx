...
//     <AccordionItem
//       value={policy.id}
//       className={`rounded-xl border bg-card px-4 md:px-5 transition-all ${isSelected ? "border-primary ring-2 ring-primary/20 shadow-[var(--shadow-soft)]" : "border-border"
//         }`}
//     >
...
//   );
// }
// prob gonna delete this stuff in future.